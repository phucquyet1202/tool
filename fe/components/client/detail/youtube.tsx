...
// Hàm kiểm tra URL hợp lệ (dùng URL constructor)
...
export default function LiveDetaiYoutubelPage() {
  ...
  const handleSubmit = () => {
    ...
    if (isValid) {
      // Nếu hợp lệ, thực hiện hành động livestream
      console.log("Phát live với:", { videoUrl, rtmpUrl });
    }
  };
  ...
  return (
    <div className="max-w-lg mx-auto p-4 space-y-4">
      <Input
        label="URL Video"
        placeholder="Nhập link video youtube muốn livestream"
        fullWidth
        value={videoUrl}
